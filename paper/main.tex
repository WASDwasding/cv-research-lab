...
\title{Screen Damage Severity Estimation for Phones and Tablets}
...
The task is to assign one ordered grade, none / minor / severe, to a phone or tablet screen. The device type is already known. Covers, frames, and cameras are out of scope.
