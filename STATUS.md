...
| 公开集 | ❌ 今天在 4060 上下 SSGD。备选 MSD。不下 NEU / MVTec |
...
- 2026-09-23 对象收成手机和平板屏幕。公开集改为 SSGD；`paper/shell.pdf` 仍是 09-22 导出的旧题名，要在 4060 上重新跑 `python paper/build_shell.py` 才更新。
